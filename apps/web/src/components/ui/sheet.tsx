...
export function SheetBody({
  ...
  return (
    <div
      className={cn(
        'flex flex-1 flex-col overflow-y-auto px-6 py-2',
        className
      )}
      {...props}
    />
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      'flex flex-none flex-col space-y-2 border-b p-6 pb-4 text-center sm:text-left',
      className
    )}
    {...props}
  />
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      'flex flex-none flex-col-reverse border-t p-6 pt-4 sm:flex-row sm:justify-end sm:space-x-2',
      className
    )}
    {...props}
  />
